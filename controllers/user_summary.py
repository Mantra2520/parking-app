...
def usersummary(userid):
    ...
    return render_template('user_summary.html', userid=userid, parked=pov, parkeda=pova, hist=lpv, hista=lpva,tres=len(lpv),tt=total_hours,tm=round(total_money,2),most_used_lot=most_used_lot,lotid=lpvlid)